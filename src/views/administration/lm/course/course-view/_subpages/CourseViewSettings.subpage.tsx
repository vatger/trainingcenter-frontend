...
export function CourseViewSettingsSubpage(props: CourseViewOverviewPartialProps) {
        ...
        CourseAdministrationService.update(data)
            .then(() => {
                if (props.courseData != null)
                    props.setCourseData({
                        ...props.courseData,
                        training_type: assignedTypes.trainingType,
                        skill_template: assignedTypes.skillTemplate,
    ...
    useEffect(() => {
        setAssignedTypes({
            trainingType: props.courseData?.training_type ?? undefined,
            skillTemplate: props.courseData?.skill_template ?? undefined,
        });
    }, [props.courseData]);
