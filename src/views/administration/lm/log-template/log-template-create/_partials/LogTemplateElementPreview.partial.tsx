...
import { TbArrowDown, TbArrowUp, TbEdit, TbTrash } from "react-icons/all";
...
export function LogTemplateElementPreviewPartial(props: { element: LogTemplateElement; index: number }) {
    return (
