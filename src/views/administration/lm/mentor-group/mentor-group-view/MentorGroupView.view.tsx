...
import MentorGroupAdminService from "../../../../../services/mentor-group/MentorGroup.admin.service";
...
export function MentorGroupViewView() {
    ...
    return (
        <>
            <PageHeader title={"Mentorengruppe Verwalten"} hideBackLink={new URL(window.location.href).searchParams.has("r")} />
