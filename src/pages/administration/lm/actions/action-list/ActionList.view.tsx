...
import ALTypes from "@/pages/administration/lm/actions/action-list/_types/AL.types";
...
export function ActionListView() {
    ...
    return (
        <>
            ...
            <Card>
                <Table searchable loading={loadingActionRequirements} columns={ALTypes.getActionRequirementTableColumns(navigate)} data={actionRequirements ?? []}/>
            </Card>
        </>
    )
}