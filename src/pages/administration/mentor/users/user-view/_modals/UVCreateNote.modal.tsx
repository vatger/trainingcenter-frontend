    ...
    return (
        <Modal show={props.show} onClose={props.onClose} title={"Notiz erstellen"}>
            <form onSubmit={createNote}>
                ...
                <Input preIcon={<TbUser size={20}/>} label={"Benutzer"} labelSmall disabled
                       value={StringHelper.getUserFullNameAndCID(props.user)} readOnly/>
                ...
                <div className={"w-full mt-4"}>
                    <div className={"flex justify-end"}>
                        <Button icon={<TbClipboardPlus size={20}/>} type={"submit"} loading={submitting}
                                color={COLOR_OPTS.PRIMARY} variant={"twoTone"}>
                            Erstellen
                        </Button>
                    </div>
                </div>
