...
import { TbCalendarPlus } from "react-icons/all";
 ...
 * @constructor
 */
export function OTRVCreateSessionModal(props: { open: boolean; onClose: () => any; trainingRequest?: TrainingRequestModel; onCreate: () => any }) {
