...
export function CAVInformationPartial(props: ActiveCourseInformationPartialProps) {
    ...
    return (
        <>
            ...
            <CAVWithdrawPartial show={showWithdrawModal} onClose={() => setShowWithdrawModal(false)} course={props.course} />
        </>
    );
}
