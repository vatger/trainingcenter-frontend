...
export function ContentContainer(props: any) {
    return (
        <div className="flex flex-col flex-auto relative w-full bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 overflow-y-auto side-nav-hide-scrollbar max-h-full">
            <Header />
