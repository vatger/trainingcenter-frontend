...
console.log("Whilst there are security measures in place to disallow access from other people, copy-pasting code blindly CAN result in your account being compromised.")
